    ...
    uiRes = {
      ...
      },
      {
        ...
        base = {
          ...
          capInsets = CCRectMake(20, 50, 500, 30),
          parent = "applyInfo"
        },
        layout = {
          anchor = ccp(0.5, 0.5),
