...
local function debug_hook(event, line)
 ...
 -- HGLog("debug_hook call event: " .. tostring(event) .. " line: " .. tostring(line))
...
local function start(controller_host, controller_port)
  ...
  --HGLog("controller_host "..controller_host.. " controller_port " .. controller_port .. " socket connect:".. tostring(socket.connect));
  local err
