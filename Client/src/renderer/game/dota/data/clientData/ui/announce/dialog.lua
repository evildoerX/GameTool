...
local function create(info)
  ...
  local buttonLabel = ed.createttf(buttonText, 20, "Sling")
...
local function createWithText(info)
  ...
  ed.setLabelColor(alert, ccc3(67, 59, 56))
...
local function createWithText(info)
  ...
  ed.setLabelColor(confirm, ccc3(67, 59, 56))
...
local function openRecharge(config)
  local function handler()
    local scene = getScene()
    local recharge = ed.ui.recharge.create(config)
