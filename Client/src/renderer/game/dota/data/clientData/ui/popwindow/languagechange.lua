...
local function create(param)
  ...
  self:createLanguageButton(height,"es-ES",320,340)
  self:createLanguageButton(height,"fr-FR",430,340)
  self:createLanguageButton(height,"id-ID",540,340)

  self:createLanguageButton(height,"it-IT",100,250)
  self:createLanguageButton(height,"ja-JP",210,250)
  self:createLanguageButton(height,"ko-KR",320,250)
