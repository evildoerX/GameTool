...
local createSDKAddition = function(self)
	...
	HGLog("registerScriptKeypadHandler createSDKAddition HGSDKType=")
  if HGFLAGANDROID and ed.isElementInTable(HGSDKType, {
  	4,
    104,
    107,
    105
  }) then
  HGLog("registerScriptKeypadHandler createSDKAddition 3")
    ed.setKeyBack(self.scene, function(event)
      xpcall(function()
      
      HGLog("CCLayerColor popScene 88")
                      ...
                      local info = {
                        ...
                        leftHandler = function()
                          xpcall(function()
														...
														backexit_switch=false
                           HGLog("registerScriptKeypadHandler leftHandler basescene applicationDidEnterBackground cancel 22") 
                          end, EDDebug)
                        end
      
                      }
                      
                      HGLog("check popScene 1 "..ed.getSceneCount())
