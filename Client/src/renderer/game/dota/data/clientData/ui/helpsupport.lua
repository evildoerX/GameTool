...
function helpsupport.formusDown()
	if initsuccess then
		HGOpenURL("http://forum.Aegwynn.com/forumdisplay.php?46-Heroes-Charge")
	end
end
...
function helpsupport.ReportIssuefunc1()
	if initsuccess then
		HGSendMailIssue(T(LSTR("CONFIGURE.ISSUE.PURCHASING")),ed.getUserid())
	end
end

function helpsupport.ReportIssuefunc2()
	if initsuccess then
		HGSendMailIssue(T(LSTR("CONFIGURE.ISSUE.CONNECTION")),ed.getUserid())
	end
end
function helpsupport.ReportIssuefunc3()
	if initsuccess then
		HGSendMailIssue(T(LSTR("CONFIGURE.ISSUE.OTHER")),ed.getUserid())
	end
end
function helpsupport.ReportIssuefunc4()
	if initsuccess then
		HGSendMailIssue(T(LSTR("CONFIGURE.ISSUE.FEEDBACK")),ed.getUserid())
	end
end
function helpsupport.ReportIssuefunc5()
	if initsuccess then
		HGSendMailIssue(T(LSTR("CONFIGURE.LOST.ACCOUNT")),ed.getUserid())
	end
end
