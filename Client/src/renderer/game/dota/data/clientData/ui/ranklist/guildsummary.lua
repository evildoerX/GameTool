...
local function create(index, data)
  ...
  ui.rank = ed.createNode({
    ...
    layout = {
      anchor = ccp(0, 0.5),
      position = ed.DGccp(115, 195)
    }
  }, ui.content)
  ui.managerTitle = ed.createNode({
    t = "Label",
    base = {
      text = T(LSTR("guildsummary.1.10.1.002")),
      size = 18
    },
    layout = {
      anchor = ccp(0, 0.5),
  ...
  ui.managerName = ed.createNode({
    ...
    layout = {
      anchor = ccp(0, 0.5),
      position = ed.DGccp(115, 150)
    }
  }, ui.content)
  ui.memberTitle = ed.createNode({
    t = "Label",
    base = {
      text = T(LSTR("guildsummary.1.10.1.003")),
      size = 18
    },
    layout = {
      anchor = ccp(0, 0.5),
  ...
  ui.memberAmount = ed.createNode({
    ...
    layout = {
      anchor = ccp(0, 0.5),
      position = ed.DGccp(160, 105)
    }
  }, ui.content)
  ui.sloganTitle = ed.createNode({
    t = "Label",
    base = {
      text = T(LSTR("guildsummary.1.10.1.004")),
      size = 18
    },
    layout = {
      anchor = ccp(0, 0.5),
  ...
  ui.slogan = ed.createNode({
    t = "Label",
    base = {
      text = data._slogan == "" and T(LSTR("guildsummary.1.10.1.005")) or data._slogan,
      size = 18
    },
    layout = {
      anchor = ccp(0, 1),
      position = ed.DGccp(160, 70)
    },
    config = {
