...
ed.uieditor.ranklistwindow = {
  ...
  },
  {
    ...
    base = {
      ...
      res = "UI/alpha/HVGA/ranklist_title_bg.png",
      name = "title_bg",
      z = 0
    },
    layout = {
  ...
  },
  {
    config = {
      ...
      opacity = 255,
      visible = true,
      scaleSize = CCSizeMake(566.41, 406.25)
    },
    t = "Scale9Sprite",
    base = {
      capInsets = CCRectMake(50, 50, 527.34, 50),
